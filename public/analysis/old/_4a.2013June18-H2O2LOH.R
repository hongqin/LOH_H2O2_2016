...
# This version summarized LOH-H2O2 results on the fly. 
...
###########
 There 2 ways to generate the means of ratio.  Average first and then ratio, or ratio first and then average. 
