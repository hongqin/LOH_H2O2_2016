...
FileList = list.files( path="../data.H2O2-LOH/", pattern="M32");  FileList; 
filename = 'M32,Jan4,2012.csv';
fullFileName = paste('../data.H2O2-LOH/',filename, sep='');
mylabel = 'M32 2012 January 4'
...
fm.s <- gnls( s ~ model1(v,w) , start = list( v = 0.2, w=2)  );
t2 = seq(0,1,by=0.001)
...
fm.b <- gnls( b ~ modelBlack(v,w) , start = list( v = 0.025, w= 1.2  )); fm.b
...
fm.b0.5 <- gnls( b0.5 ~ modelBlack0.5(v,w) , start = list( v = 0.025, w=1.5)  );   fm.b0.5
