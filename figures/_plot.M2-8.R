...
FileList = list.files( path="../data.H2O2-LOH/", pattern="M2-8");  FileList; 
filename = 'M2-8,Dec19 2011.csv';
fullFileName = paste('../data.H2O2-LOH/',filename, sep='');
mylabel = 'M2-8 2011 Dec 19'
...
fm.s <- gnls( s ~ model1(v,w) , start = list( v = 0.05, w=0.5)  );
t2 = seq(0,1,by=0.001)
...
mtext( "Cb0.5",side=1,at=c(Cb0.5+0.002),line=-1, cex=0.8 );
