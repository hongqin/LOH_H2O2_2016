...
FileList = list.files( path="../data.H2O2-LOH/", pattern="M13");  FileList; 
filename = 'M13,May18.2011.M13.H2O2.LOH.csv';
fullFileName = paste('../data.H2O2-LOH/',filename, sep='');
mylabel = 'M13 2011 May 18'
...
fm.b <- gnls( b ~ modelBlack(v,w) , start = list( v = 0.005, w= 1.2  )); fm.b
