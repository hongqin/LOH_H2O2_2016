...
FileList = list.files( path="../data.H2O2-LOH/", pattern="M34");  FileList; 
#[1] "M34,042011.H2O2onLOH.csv"  "M34.08232011.H2O2.LOH.csv"

filename = 'M34.08232011.H2O2.LOH.csv';
fullFileName = paste('../data.H2O2-LOH/',filename, sep='');
mylabel = 'M34 2011 August 23'
